...
class UserRepository:
    ...
    async def create(self, telegram_id: int, telegram_username: str = "Abobus", balance: float = 0, role: Role = Role.guest, active: bool = False, auto_pay: bool = True, created_date: datetime = datetime.now(UTC)) -> None:
