...
from database.models.server_panel import ServerPanel
...
server_panel = ServerPanel(server_id=server.id, panel_path="", login="login", password="password", vless_id=0, vless_reality_id=0, vmess_id=0)
